...
function receiveNewPlayer(msg) {
  ...
  if (actualGame === undefined) {
    returnMessage = createErrorMessage(`No se ha encontrado una partida con el identificador: ${msg.gameId}.`);
  } else if (actualGame.playing === true) {
    returnMessage = createErrorMessage(`La partida con el identificador: ${msg.gameId} ya se está jugando.`);
  } else {
